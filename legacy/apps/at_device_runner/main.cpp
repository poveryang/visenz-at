                      ...
                      const std::string &image_path)
{
    ...
    out << "{\"step\":" << result.trace.step_index << ",\"phase\":\""
        << at::ToString(result.trace.phase) << "\",\"difficulty\":\""
        << at::ToString(result.trace.difficulty) << "\",\"action\":\""
        ...
        << result.trace.stage_step_count << ",\"historical_max_difficulty\":\""
        << at::ToString(result.trace.historical_max_difficulty) << "\",\"decode_used\":"
...
int RunBatch(const Options &options)
{
    ...
    at::ATSession session(at::SessionConfig{});
...
int RunServer(const Options &options)
{
    ...
    std::cout << "at_runner listening on port " << options.port << '\n';
    bool running = true;
    while (running) {
        ...
        while (running) {
            ...
            if (*command == "get_status") {
                ...
                (void)SendResponse(client_fd, AtStepResponse(camera, session, current_params));
