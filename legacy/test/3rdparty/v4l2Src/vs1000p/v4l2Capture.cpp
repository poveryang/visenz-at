...
#define MAXVALUE_PATH "/sys/devices/platform/soc@0/30800000.bus/30a30000.i2c/i2c-1/1-0010/max"
...
int V4L2Capture::get1000Plightboardversion(void)
{
    int ret = -1;
    Rpmsg& rpmsg_instance = Rpmsg::getInstance();
    ret = rpmsg_instance.get_lightboard_version();
    return ret;
}
