...
#ifdef __KERNEL__
#inc "nvt_type.h"
#inc "platform.h"       //inc syntax cross different platform: ARM, or MIPS

#elif defined __ECOS
#inc "kwrap/nvt_type.h"
//#inc "cyg/compat/uitron/uit_type.h"
#inc "kwrap/platform.h"       //inc syntax cross different platform: ARM, or MIPS
#else
#include "kwrap/nvt_type.h"
#include "kwrap/platform.h"       //inc syntax cross different platform: ARM, or MIPS
#endif
...
// in two (or more) files and one file inc another one.
#define STATIC_ASSERT(expr) \
