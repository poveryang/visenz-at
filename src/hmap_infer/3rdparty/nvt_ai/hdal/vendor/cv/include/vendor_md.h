...
********************************************************************/
#include "hd_type.h"
#define VENDOR_MD_IOREMAP_IN_KERNEL 1
...
typedef struct _VENDOR_MDBC_MOR_PARAM {
    ...
    VENDOR_MDBC_MOR_SEL mor_sel0;           ///< Morphological type
    VENDOR_MDBC_MOR_SEL mor_sel1;           ///< Morphological type
    VENDOR_MDBC_MOR_SEL mor_sel2;           ///< Morphological type
    VENDOR_MDBC_MOR_SEL mor_sel3;           ///< Morphological type
...
typedef enum {
	...
	VENDOR_MD_PARAM_GET_REG,			///< set isr callback, data_type: KDRV_MD_ISRCB
...
extern INT32 vendor_md_get_vendor_version(CHAR* vendor_version);
extern INT32 vendor_md_get_kdrv_version(CHAR* kdrv_version);
