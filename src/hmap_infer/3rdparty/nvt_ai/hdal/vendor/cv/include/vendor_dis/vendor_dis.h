...
#define VENDOR_DIS_IOREMAP_IN_KERNEL 1
...
extern INT32 vendor_dis_get_kdrv_version(CHAR* kdrv_version);
extern INT32 vendor_dis_get_vendor_version(CHAR* vendor_version);
