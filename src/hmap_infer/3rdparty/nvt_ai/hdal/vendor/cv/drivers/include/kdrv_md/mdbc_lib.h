...
typedef struct _MDBC_MOR_PARAM {
    ...
    MDBC_MOR_SEL mor_sel0;                  ///< Morphological type
    MDBC_MOR_SEL mor_sel1;                  ///< Morphological type
    MDBC_MOR_SEL mor_sel2;                  ///< Morphological type
    MDBC_MOR_SEL mor_sel3;                  ///< Morphological type
} MDBC_MOR_PARAM;
//@}
