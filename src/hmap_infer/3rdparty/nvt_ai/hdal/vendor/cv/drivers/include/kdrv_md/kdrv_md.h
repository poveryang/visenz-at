...
typedef struct _KDRV_MDBC_MOR_PARAM {
    ...
    KDRV_MDBC_MOR_SEL mor_sel0;             ///< Morphological type
    KDRV_MDBC_MOR_SEL mor_sel1;             ///< Morphological type
    KDRV_MDBC_MOR_SEL mor_sel2;             ///< Morphological type
    KDRV_MDBC_MOR_SEL mor_sel3;             ///< Morphological type
} KDRV_MDBC_MOR_PARAM;
//@}
