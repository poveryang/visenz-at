#ifndef _MDBC_NT98520_H_
#define _MDBC_NT98520_H_
...
/*
    ...
    D_COLOUR:    [0x0, 0xf],			bits : 11_8
    R_COLOUR:    [0x0, 0xff],			bits : 19_12
    D_LBSP  :    [0x0, 0xf],			bits : 23_20
    R_LBSP  :    [0x0, 0xf],			bits : 27_24
*/
#define MODEL_MATCH_REGISTER0_OFS 0x004c
REGDEF_BEGIN(MODEL_MATCH_REGISTER0)
    REGDEF_BIT(LBSP_TH ,        8)
    REGDEF_BIT(D_COLOUR,        4)
...
/*
    TH_ERO  :    [0x0, 0xf],			bits : 3_0
    TH_DIL  :    [0x0, 0xf],			bits : 7_4
    MOR_SEL0:    [0x0, 0x3],			bits : 9_8
    MOR_SEL1:    [0x0, 0x3],			bits : 13_12
    MOR_SEL2:    [0x0, 0x3],			bits : 17_16
    MOR_SEL3:    [0x0, 0x3],			bits : 21_20
*/
#define MORPHOLOGICAL_PROCESS_REGISTER_OFS 0x0064
REGDEF_BEGIN(MORPHOLOGICAL_PROCESS_REGISTER)
    REGDEF_BIT(TH_ERO  ,        4)
    REGDEF_BIT(TH_DIL  ,        4)
    REGDEF_BIT(MOR_SEL0,        2)
    REGDEF_BIT(        ,        2)
    REGDEF_BIT(MOR_SEL1,        2)
    REGDEF_BIT(        ,        2)
    REGDEF_BIT(MOR_SEL2,        2)
    REGDEF_BIT(        ,        2)
    REGDEF_BIT(MOR_SEL3,        2)
...
/*
    ...
    ROI_D_COLOUR0:    [0x0, 0xf],			bits : 11_8
    ROI_R_COLOUR0:    [0x0, 0xff],			bits : 19_12
    ROI_D_LBSP0  :    [0x0, 0xf],			bits : 23_20
    ROI_R_LBSP0  :    [0x0, 0xf],			bits : 27_24
*/
#define ROI0_REGISTER2_OFS 0x0084
REGDEF_BEGIN(ROI0_REGISTER2)
    REGDEF_BIT(ROI_LBSP_TH0 ,        8)
    REGDEF_BIT(ROI_D_COLOUR0,        4)
...
/*
    ...
    ROI_D_COLOUR1:    [0x0, 0xf],			bits : 11_8
    ROI_R_COLOUR1:    [0x0, 0xff],			bits : 19_12
    ROI_D_LBSP1  :    [0x0, 0xf],			bits : 23_20
    ROI_R_LBSP1  :    [0x0, 0xf],			bits : 27_24
*/
#define ROI1_REGISTER2_OFS 0x0094
REGDEF_BEGIN(ROI1_REGISTER2)
    REGDEF_BIT(ROI_LBSP_TH1 ,        8)
    REGDEF_BIT(ROI_D_COLOUR1,        4)
...
/*
    ...
    ROI_D_COLOUR2:    [0x0, 0xf],			bits : 11_8
    ROI_R_COLOUR2:    [0x0, 0xff],			bits : 19_12
    ROI_D_LBSP2  :    [0x0, 0xf],			bits : 23_20
    ROI_R_LBSP2  :    [0x0, 0xf],			bits : 27_24
*/
#define ROI2_REGISTER2_OFS 0x00a4
REGDEF_BEGIN(ROI2_REGISTER2)
    REGDEF_BIT(ROI_LBSP_TH2 ,        8)
    REGDEF_BIT(ROI_D_COLOUR2,        4)
...
/*
    ...
    ROI_D_COLOUR3:    [0x0, 0xf],			bits : 11_8
    ROI_R_COLOUR3:    [0x0, 0xff],			bits : 19_12
    ROI_D_LBSP3  :    [0x0, 0xf],			bits : 23_20
    ROI_R_LBSP3  :    [0x0, 0xf],			bits : 27_24
*/
#define ROI3_REGISTER2_OFS 0x00b4
REGDEF_BEGIN(ROI3_REGISTER2)
    REGDEF_BIT(ROI_LBSP_TH3 ,        8)
    REGDEF_BIT(ROI_D_COLOUR3,        4)
...
/*
    ...
    ROI_D_COLOUR4:    [0x0, 0xf],			bits : 11_8
    ROI_R_COLOUR4:    [0x0, 0xff],			bits : 19_12
    ROI_D_LBSP4  :    [0x0, 0xf],			bits : 23_20
    ROI_R_LBSP4  :    [0x0, 0xf],			bits : 27_24
*/
#define ROI4_REGISTER2_OFS 0x00c4
REGDEF_BEGIN(ROI4_REGISTER2)
    REGDEF_BIT(ROI_LBSP_TH4 ,        8)
    REGDEF_BIT(ROI_D_COLOUR4,        4)
...
/*
    ...
    ROI_D_COLOUR5:    [0x0, 0xf],			bits : 11_8
    ROI_R_COLOUR5:    [0x0, 0xff],			bits : 19_12
    ROI_D_LBSP5  :    [0x0, 0xf],			bits : 23_20
    ROI_R_LBSP5  :    [0x0, 0xf],			bits : 27_24
*/
#define ROI5_REGISTER2_OFS 0x00d4
REGDEF_BEGIN(ROI5_REGISTER2)
    REGDEF_BIT(ROI_LBSP_TH5 ,        8)
    REGDEF_BIT(ROI_D_COLOUR5,        4)
...
/*
    ...
    ROI_D_COLOUR6:    [0x0, 0xf],			bits : 11_8
    ROI_R_COLOUR6:    [0x0, 0xff],			bits : 19_12
    ROI_D_LBSP6  :    [0x0, 0xf],			bits : 23_20
    ROI_R_LBSP6  :    [0x0, 0xf],			bits : 27_24
*/
#define ROI6_REGISTER2_OFS 0x00e4
REGDEF_BEGIN(ROI6_REGISTER2)
    REGDEF_BIT(ROI_LBSP_TH6 ,        8)
    REGDEF_BIT(ROI_D_COLOUR6,        4)
...
/*
    ...
    ROI_D_COLOUR7:    [0x0, 0xf],			bits : 11_8
    ROI_R_COLOUR7:    [0x0, 0xff],			bits : 19_12
    ROI_D_LBSP7  :    [0x0, 0xf],			bits : 23_20
    ROI_R_LBSP7  :    [0x0, 0xf],			bits : 27_24
*/
#define ROI7_REGISTER2_OFS 0x00f4
REGDEF_BEGIN(ROI7_REGISTER2)
    REGDEF_BIT(ROI_LBSP_TH7 ,        8)
    REGDEF_BIT(ROI_D_COLOUR7,        4)
