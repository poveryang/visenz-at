...
typedef enum {
    KDRV_DIS_SUBIN_1x = 0,  ///< original
    KDRV_DIS_SUBIN_2x = 1,  ///< 1/2 subsample
    KDRV_DIS_SUBIN_4x = 2,  ///< 1/4 subsample
    ENUM_DUMMY4WORD(KDRV_DIS_SUBIN)
} KDRV_DIS_SUBIN;
...
typedef enum {
	...
	KDRV_DIS_PARAM_BLOCK_DIM,                   /// [Set/Get], use KDRV_BLOCKS_DIM enum, get the block dim
	KDRV_DIS_PARAM_SUBSAMPLE_SEL,               /// [Set/Get], use KDRV_DIS_SUBIN enum
