...
#define DIS_IOREMAP_IN_KERNEL 1
...
#define DIS_1M_HZ  1000000

extern VOID dis_platform_request_irq(VOID *isr_handler);
extern VOID dis_platform_create_resource(UINT32 clk_freq);
...
extern UINT32 dis_platform_dma_flush_mem2device(UINT32 addr, UINT32 size);
extern UINT32 dis_platform_va2pa(UINT32 addr);

extern ER     dis_platform_set_clock_rate(UINT32 clock);

extern UINT32 dis_platform_pa2va_remap(UINT32 pa, UINT32 sz, UINT8 is_mem2dev);

extern VOID dis_platform_pa2va_unmap(UINT32 va, UINT32 pa);

extern UINT32 dis_platform_get_clock_rate(VOID);
#endif
