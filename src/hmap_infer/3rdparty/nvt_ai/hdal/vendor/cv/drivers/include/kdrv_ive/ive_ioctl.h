...
#define IVE_IOC_GET_VERSION               _VOS_IOWR(IVE_IOC_COMMON_TYPE, 39, void*)
#define IVE_IOC_TRIGGER_NONBLOCK          _VOS_IOWR(IVE_IOC_COMMON_TYPE, 40, void*)
#define IVE_IOC_WAITDONE_NONBLOCK         _VOS_IOWR(IVE_IOC_COMMON_TYPE, 41, void*)
