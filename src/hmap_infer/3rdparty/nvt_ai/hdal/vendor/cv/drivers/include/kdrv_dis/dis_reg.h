...
#ifndef _DIS_MULTI_CHIP_REG_H_
#define _DIS_MULTI_CHIP_REG_H_
...
/*
    ...
    INTE_LL_ERROR2 :    [0x0, 0x1],			bits : 11
*/
...
/*
    ...
    BLK_VERT     :    [0x0, 0x3f],			bits : 13_8
    NUMMDS2DO    :    [0x0, 0x1f],			bits : 20_16
    ETH_SUBIN    :    [0x0, 0x2],			bits : 24_25
    ETH_SUBIN_SEL:    [0x0, 0x3],			bits : 26_27
*/
#define DIS_ME_REGISTER0_OFS_528 0x0020
REGDEF_BEGIN(DIS_ME_REGISTER0)
    REGDEF_BIT(DIS_SR       ,        1)
    REGDEF_BIT(DIS_BLOCKSIZE,        1)
    REGDEF_BIT(DIS_LUT      ,        1)
...
REGDEF_END(DIS_ME_REGISTER0_528)
