...
/* Pooling layer */
extern HD_RESULT custnn_cpu_pool_process(CUSTNN_POOL_PARM *p_parm, UINTPTR in_addr, UINTPTR out_addr);
extern HD_RESULT custnn_cpu_elt_process(CUSTNN_ELT_PARM* p_parm, UINTPTR in0_addr, UINTPTR in1_addr, UINTPTR out_addr);
/* concat layer */
#if CUST_SUPPORT_MULTI_IO
extern HD_RESULT custnn_cpu_concat_process(CUSTNN_CONCAT_PARM* p_parm, UINTPTR temp_buf_addr, 
...
extern HD_RESULT custnn_cpu_slice_process(CUSTNN_SLICE_PARM* p_parm, UINTPTR temp_buf_addr, 
 NN_DATA* input_info, NN_CUSTOM_DIM* input_dim, INT32 *p_isf_parm, UINT32 input_num, 
 NN_DATA* output_info, NN_CUSTOM_DIM* output_dim, INT32 *p_osf_parm, UINT32 output_num);
#endif
#ifdef __cplusplus
