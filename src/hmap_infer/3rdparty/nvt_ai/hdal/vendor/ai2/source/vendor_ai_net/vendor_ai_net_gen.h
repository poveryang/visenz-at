...
extern HD_RESULT vendor_ais_net_input_init(VENDOR_AIS_IMG_PARM *p_input_info, UINT32 net_id, UINT32 layer_id);
...
#endif
extern BOOL vendor_ais_check_component_ver(VOID);
