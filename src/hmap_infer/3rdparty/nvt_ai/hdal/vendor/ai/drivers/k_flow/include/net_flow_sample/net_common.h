...
********************************************************************/
int nn_write_file(char *filename, void *data, UINT32 count, unsigned long long *offset);
int nn_read_file(char *filename, void *data, UINT32 count, unsigned long long *offset);
