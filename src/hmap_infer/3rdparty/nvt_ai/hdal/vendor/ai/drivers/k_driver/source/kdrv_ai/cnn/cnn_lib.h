...
#define CNN_INTE_ALL                    0x001f030d
#define CNN_INTE_APP_ALL                0x001e020d
#define CNN_INTE_LL_ALL                 0x001e030c
//@}
...
Structure of information in CNN LRN parameters.
*/
//@{
typedef struct _CNN_LRN_PARM {
	UINT32 lrn_alpha;                            ///< alpha  [0, 1<<13]
	UINT32 lrn_shift;                            ///< left shift of lrn output [0, 5]
	UINT32 lrn_beta;                             ///< 8 bits of fraction [0, 1<<7]
	UINT32 lrn_n;                                ///< Number of channelsMax [0, 1]
} CNN_LRN_PARM;
//@}
...
/**
CNN clamp Parameters.

Structure of information in CNN clamp parameters.
*/
//@{
typedef struct _CNN_CLAMP_PARM {
	UINT32 clamp_th[6];                            
} CNN_CLAMP_PARM;
//@}
...
*/
//@{
typedef struct _CNN_OUT_CLAMP_RST {
	UINT16 clamp_count_pos[6];       
	UINT16 clamp_count_neg[6];           
	UINT32 clamp_max_val[6];                        
} CNN_OUT_CLAMP_RST;
//@}
/**
User Definition
...
typedef struct _CNN_PARAM {
	...
	CNN_LRN_PARM lrn_parm;

	CNN_OUT_SCALE_PARM out_scale_parm;
	CNN_CLAMP_PARM clamp_parm;
	CNN_OUT_CLAMP_RST out_clamp_rst;
