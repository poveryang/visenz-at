...
extern void iq_flow_ext_set_tmnr_nr_type(IQ_ID id, BOOL type);
...
extern ER iqt_api_nnsc_get_cmd(IQT_ITEM item, UINT32 addr);
extern ER iqt_api_nnsc_set_cmd(IQT_ITEM item, UINT32 addr);

// From iq_lib.h
extern UINT32 iq_auto_wdr_dark_th;
extern UINT32 iq_auto_wdr_dr_th;
extern UINT32 iq_auto_wdr_dark_compensate;
extern UINT32 iq_auto_defog_airlight_th;
extern UINT32 iq_auto_defog_airlight_diff_max_ratio;
extern UINT32 iq_auto_defog_cnt_ratio_th1;
extern UINT32 iq_auto_defog_cnt_ratio_th2;
