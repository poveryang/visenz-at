...
typedef struct _ISP_DEV_INFO {
	...
	ISP_EDGE_STCS edge_stcs_cap[ISP_ID_MAX_NUM];
	...
	// mapping usage
	BOOL ipp_to_sen_id_map_en;
	BOOL ipp_to_sie_id_map_en;
	BOOL enc_to_sen_id_map_en;
	BOOL enc_to_sie_id_map_en;
	...
	URECT sie_la_roi[ISP_ID_MAX_NUM];
