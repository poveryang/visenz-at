...
extern ER kflow_videoenc_set(UINT32 id, KFLOW_VIDEOENC_ISP_ITEM item, void *data);
extern ER kflow_videoenc_get(UINT32 id, KFLOW_VIDEOENC_ISP_ITEM item, void *data);
