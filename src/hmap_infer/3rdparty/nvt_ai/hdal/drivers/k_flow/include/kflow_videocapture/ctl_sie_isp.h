...
typedef struct _CTL_SIE_BP {
	UINT32 sie_bp_1;	//set bp value when trig evt inc ISP_EVT_SIE_BP1
	UINT32 sie_bp_2;	//set bp value when trig evt inc ISP_EVT_SIE_BP2
	UINT32 sie_bp_3;	//set bp value when trig evt inc ISP_EVT_SIE_BP3
} CTL_SIE_BP;
