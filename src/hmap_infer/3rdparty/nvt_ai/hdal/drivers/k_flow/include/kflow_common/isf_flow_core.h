...
#define ISF_VDO_HEADER_SIZE    1024   ///< size of VRAW internal header in BYTES, inc ISF_DATA + VDO_FRAME + (internal info)
...
typedef struct _ISF_STATE_ {
	...
	UINT32 h_proc; ///< h_isf +0x8000, for multiple process
} ISF_STATE;
...
extern ISF_RV _isf_unit_set_param(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 nport, UINT32 param, UINT32* p_value);
extern ISF_RV _isf_unit_set_struct_param(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 nport, UINT32 param, UINT32* p_value, UINT32 size);
extern ISF_RV _isf_unit_get_param(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 nport, UINT32 param, UINT32* p_value);
extern ISF_RV _isf_unit_get_struct_param(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 nport, UINT32 param, UINT32* p_value, UINT32 size);
