...
enum {
	...
	AUDCAP_PARAM_GAIN_LEVEL,
	AUDCAP_PARAM_TDM_CH,
	AUDCAP_PARAM_AUD_ALC_CONFIG,
	AUDCAP_PARAM_MONO_EXPAND,
	AUDCAP_PARAM_AEC_REF_BYPASS_FUNC,
	AUDCAP_PARAM_AEC_REF_BYPASS_ENABLE,
	AUDCAP_PARAM_AEC_PRE_INIT,
};
...
typedef struct _AUDCAP_ALC_CONFIG {
	BOOL   enable;
	...
	INT32  max_gain;                    ///< Embedded codec ALC maximum PGA gain. Valid setting range is 0x00 ~ 0x1F (-21 ~ +25.5 (dB)).
	INT32  min_gain;                    ///< Embedded codec ALC minimum PGA gain. Valid setting range is 0x00 ~ 0x1F (-21 ~ +25.5 (dB)).
} AUDCAP_ALC_CONFIG;
