...
static struct file_operations proc_cmd_fops = {
	.owner   = THIS_MODULE,
	.open    = nvt_ctl_vpe_proc_cmd_open,
	.read    = seq_read,
	.llseek  = seq_lseek,
	.release = single_release,
	.write   = nvt_ctl_vpe_proc_cmd_write
};
...
{
	seq_printf(sfile, "=====================================================================\n");
	seq_printf(sfile, " ctl vpe message\n");
	seq_printf(sfile, "=====================================================================\n");
	return 0;
}
...
static struct file_operations proc_help_fops = {
	.owner  = THIS_MODULE,
	.open   = nvt_ctl_vpe_proc_help_open,
	.release = single_release,
	.read   = seq_read,
	.llseek = seq_lseek,
};
...
static struct file_operations proc_info_fops = {
	.owner  = THIS_MODULE,
	.open   = nvt_ctl_vpe_proc_info_open,
	.release = single_release,
	.read   = seq_read,
	.llseek = seq_lseek,
};
