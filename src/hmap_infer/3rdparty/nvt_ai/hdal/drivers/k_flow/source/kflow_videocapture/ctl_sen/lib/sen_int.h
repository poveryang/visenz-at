...
extern INT32 sen_ctrl_chk_support_type(CTL_SEN_ID id);
...
extern INT32 sen_ctrl_mclksync_init(CTL_SEN_ID id, CTL_SEN_MODE mode);
extern INT32 sen_ctrl_mclksync_uninit(CTL_SEN_ID id, CTL_SEN_MODE mode);
