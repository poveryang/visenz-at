...
extern BOOL _isf_audcap_sxcmd_dumpque(CHAR *strCmd);
extern BOOL _isf_audcap_sxcmd_dumpbuf(CHAR *strCmd);
extern BOOL _isf_audcap_sxcmd_dump_que_num(CHAR *strCmd);
