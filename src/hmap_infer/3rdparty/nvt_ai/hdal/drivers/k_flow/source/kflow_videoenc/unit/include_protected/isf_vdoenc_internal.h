...
#define ISF_VDOENC_IN_NUM  4
#define ISF_VDOENC_OUT_NUM 4
#else
...
//process data
extern void _isf_vdoenc_do_input_mask(ISF_UNIT *p_thisunit, UINT32 iport, void *in, void *out, BOOL b_before_rotate);
extern void _isf_vdoenc_do_input_osd(ISF_UNIT *p_thisunit, UINT32 iport, void *in, void *out, BOOL b_before_rotate);
extern void _isf_vdoenc_finish_input_mask(ISF_UNIT *p_thisunit, UINT32 iport);
extern void _isf_vdoenc_finish_input_osd(ISF_UNIT *p_thisunit, UINT32 iport);
