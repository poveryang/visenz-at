...
typedef struct NVTMPP_HEAP_LINK {
	...
	UINT32 block_addr;              ///<  The block physical address.
	UINT32 block_va;                ///<  The block virtual address.
...
extern INT32 nvtmpp_heap_free(NVTMPP_DDR ddr, void *pv);
