...
typedef void (*SIE_DRV_ISR_FP)(UINT32 int_sts, SIE_ENGINE_STATUS_INFO_CB *info);
...
extern void sie_calcObPlnScl(SIE_OB_PLANE_INFO *pObpParam, SIE_OB_PLANE_ADJ_INFO *pObpAdjParam);
...
extern void sie_calcYoutInfo(SIE_YOUT_GRP_INFO *pSzGrpInfo, SIE_YOUT_ADJ_INFO *pSzAdjInfo);
...
extern void sie_lib_get_bp(UINT32 id, UINT32 *bp1, UINT32 *bp2);
extern void sie_lib_calc_row_time(UINT32 id, UINT32 calc_start_line, UINT32 calc_end_line);
