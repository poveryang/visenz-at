...
REGDEF_BIT(, 1) 
REGDEF_BIT(spi_rdrf_int_en, 1) /* Receive data register full.  */
REGDEF_BIT(, 1)
...
REGDEF_BIT(, 3)
REGDEF_BIT(trslen, 2)               /* gyro transfer length: how many OPs 0x0:OP0, ..., 0x3:OP0~OP3 */
REGDEF_BIT(, 2)
REGDEF_BIT(gyro_vdsrc, 2)           /* select VD source 0x0:SIE1, 0x1:SIE2, 0x2: SIE4, 0x3: SIE5 */
REGDEF_BIT(, 2)
REGDEF_BIT(len_op0, 3)              /* OP0 byte length 0x0:1B, ..., 0x7:8B */
REGDEF_BIT(, 1)
REGDEF_BIT(len_op1, 3)              /* OP1 byte length 0x0:1B, ..., 0x7:8B */
REGDEF_BIT(, 1)
REGDEF_BIT(len_op2, 3)              /* OP2 byte length 0x0:1B, ..., 0x7:8B */
REGDEF_BIT(, 1)
REGDEF_BIT(len_op3, 3)              /* OP3 byte length 0x0:1B, ..., 0x7:8B */
REGDEF_BIT(, 1)
