...
#else
#define H26X_TIME_OUT_INT		0x00000000	/* Timeout interrupt */
#endif
#if 1
#define H26X_FRAME_TIME_OUT_INT	0x00000000	/* Frame Timeout interrupt */
#else
...
#define H26X_SRC_D2D_OVERWRITE_EN 0x02000000  /* source low delay overwrite interrupt mask bit */
...
#define H26X_REG_REPORT_2_START_OFFSET 0x9C0
#define H26X_REG_PLUG_IN_4_START_OFFSET 0xAC0
#define H26X_REG_PLUG_IN_4_FINISH_OFFSET 0xBCC
...
#define H26X_REG_PLUG_IN_4_SIZE			(((H26X_REG_PLUG_IN_4_FINISH_OFFSET - H26X_REG_PLUG_IN_4_START_OFFSET)>>2) + 1)
#define HW_VERSION_520              0x03131256
...
typedef enum _H26XREPORT_{
	...
	H26X_RRC_COEFF2,
    H26X_RRC_COEFF3,
	H26X_REPORT_NUMBER = 64 //need align-64
}H26XREPORT;
#define H26X_REG_REPORT_SIZE			SIZE_32X(H26X_REPORT_NUMBER * 4 + H26X_MAX_DUMMY_WRITE)
typedef enum _H26XREPORT_2_{
    H26X_PSNR_MOTION_Y_LSB = 0,
    H26X_PSNR_MOTION_Y_MSB,
    H26X_PSNR_MOTION_U_LSB,
    H26X_PSNR_MOTION_U_MSB,
    H26X_PSNR_MOTION_V_LSB,
    H26X_PSNR_MOTION_V_MSB,
    H26X_PSNR_BGR_Y_LSB,
    H26X_PSNR_BGR_Y_MSB,
    H26X_PSNR_BGR_U_LSB,
    H26X_PSNR_BGR_U_MSB,
    ...
    H26X_JND_GRAD,
    H26X_JND_GRAD_CNT,
	H26X_REPORT_2_NUMBER = 64 //need align-64
}H26XREPORT_2;
...
extern void h26xEmuClkSel2(UINT32 uiVal, UINT32 speed);
