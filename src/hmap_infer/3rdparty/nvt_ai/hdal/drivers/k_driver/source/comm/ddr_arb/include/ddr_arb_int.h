...
#define ARB2_SETREG(ofs,value)	OUTW(IOADDR_DDR_ARB2_REG_BASE+(ofs),(value))
#define ARB_GETREG(ofs)		INW(IOADDR_DDR_ARB_REG_BASE+(ofs))
#define ARB2_GETREG(ofs)	INW(IOADDR_DDR_ARB2_REG_BASE+(ofs))

#define PROT_SETREG(ofs,value)	OUTW(IOADDR_DDR_ARB_PROT_REG_BASE+(ofs),(value))
#define PROT2_SETREG(ofs,value)	OUTW(IOADDR_DDR_ARB2_PROT_REG_BASE+(ofs),(value))
#define PROT_GETREG(ofs)		INW(IOADDR_DDR_ARB_PROT_REG_BASE+(ofs))
#define PROT2_GETREG(ofs)	INW(IOADDR_DDR_ARB2_PROT_REG_BASE+(ofs))
