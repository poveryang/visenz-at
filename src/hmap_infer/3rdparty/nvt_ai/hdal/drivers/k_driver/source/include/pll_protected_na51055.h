...
typedef enum {
	...
	PLL_CLKSEL_NUE =            PLL_CLKSEL_R2_OFFSET + 28,  //< Clock Select Module ID: NUE
	...
	PLL_CLKSEL_H265 =           PLL_CLKSEL_R3_OFFSET + 4,   //< Clock Select Module ID: H.265
	...
	//SPI Clock Divider bit definition 2
...
*/
//@{
#define PLL_CLKSEL_CNN_240        (0x00 << (PLL_CLKSEL_CNN - PLL_CLKSEL_R1_OFFSET)) //< Select CNN clock as 192MHz
#define PLL_CLKSEL_CNN_320        (0x01 << (PLL_CLKSEL_CNN - PLL_CLKSEL_R1_OFFSET)) //< Select CNN clock as 320MHz
#define PLL_CLKSEL_CNN_480        (0x02 << (PLL_CLKSEL_CNN - PLL_CLKSEL_R1_OFFSET)) //< Select CNN clock as 480MHz
#define PLL_CLKSEL_CNN_PLL10      (0x03 << (PLL_CLKSEL_CNN - PLL_CLKSEL_R1_OFFSET)) //< Select CNN clock as PLL10
//@}
...
*/
//@{
#define PLL_CLKSEL_IPE_240        (0x00 << (PLL_CLKSEL_IPE - PLL_CLKSEL_R1_OFFSET)) //< Select IPE clock as 192MHz
...
*/
//@{
#define PLL_CLKSEL_DIS_240        (0x00 << (PLL_CLKSEL_DIS - PLL_CLKSEL_R1_OFFSET)) //< Select DIS clock as 192MHz
...
*/
//@{
#define PLL_CLKSEL_IME_240        (0x00 << (PLL_CLKSEL_IME - PLL_CLKSEL_R1_OFFSET)) //< Select IME clock as 192MHz
...
*/
//@{
#define PLL_CLKSEL_MDBC_240        (0x00 << (PLL_CLKSEL_MDBC - PLL_CLKSEL_R1_OFFSET)) //< Select MDBC clock as 192MHz
...
*/
//@{
#define PLL_CLKSEL_DCE_240        (0x00 << (PLL_CLKSEL_DCE - PLL_CLKSEL_R1_OFFSET)) //< Select DCE clock as 192MHz
...
*/
//@{
#define PLL_CLKSEL_IFE_240        (0x00 << (PLL_CLKSEL_IFE - PLL_CLKSEL_R2_OFFSET)) //< Select IFE clock as 192MHz
...
*/
//@{
#define PLL_CLKSEL_IFE2_240       (0x00 << (PLL_CLKSEL_IFE2 - PLL_CLKSEL_R2_OFFSET))  //< Select IFE2 clock as 192MHz
#define PLL_CLKSEL_IFE2_320       (0x01 << (PLL_CLKSEL_IFE2 - PLL_CLKSEL_R2_OFFSET))  //< Select IFE2 clock as 320MHz
...
#define PLL_CLKSEL_SIE_MCLKSRC_PLL10	(0x02 << (PLL_CLKSEL_SIE_MCLKSRC - PLL_CLKSEL_R2_OFFSET))   //< Select SIE MCLK clock source as PLL10 (for CNN)
...
#define PLL_CLKSEL_SIE_MCLK2SRC_PLL10	(0x02 << (PLL_CLKSEL_SIE_MCLK2SRC - PLL_CLKSEL_R2_OFFSET)) //< Select SIE MCLK2 clock source as PLL10 (for CNN)
...
#define PLL_CLKSEL_SIE_MCLK3SRC_PLL10	(0x02 << (PLL_CLKSEL_SIE_MCLK3SRC - PLL_CLKSEL_R2_OFFSET)) //< Select SIE MCLK3 clock source as PLL10 (for CNN)
#define PLL_CLKSEL_SIE_MCLK3SRC_PLL18	PLL_CLKSEL_SIE_MCLK3SRC_PLL10 							   //< Select SIE MCLK3 clock source as PLL18 (for sensor3)
...
*/
//@{
#define PLL_CLKSEL_NUE_240        (0x00 << (PLL_CLKSEL_NUE - PLL_CLKSEL_R2_OFFSET)) //< Select NUE clock as 192MHz
#define PLL_CLKSEL_NUE_320        (0x01 << (PLL_CLKSEL_NUE - PLL_CLKSEL_R2_OFFSET)) //< Select NUE clock as 320MHz
#define PLL_CLKSEL_NUE_480        (0x02 << (PLL_CLKSEL_NUE - PLL_CLKSEL_R2_OFFSET)) //< Select NUE clock as 480MHz
#define PLL_CLKSEL_NUE_PLL10      (0x03 << (PLL_CLKSEL_NUE - PLL_CLKSEL_R2_OFFSET)) //< Select NUE clock as PLL10
//@}
...
*/
//@{
#define PLL_CLKSEL_NUE2_240        (0x00 << (PLL_CLKSEL_NUE2 - PLL_CLKSEL_R2_OFFSET)) //< Select NUE2 clock as 192MHz
...
#define PLL_CLKSEL_NUE2_PLL13      (0x03 << (PLL_CLKSEL_NUE2 - PLL_CLKSEL_R2_OFFSET)) //< Select NUE2 clock as PLL13
//@}
...
#define PLL_CLKSEL_JPEG_480       (0x02 << (PLL_CLKSEL_JPEG - PLL_CLKSEL_R3_OFFSET)) //< Select JPEG clock as 320MHz
#define PLL_CLKSEL_JPEG_PLL9      (0x03 << (PLL_CLKSEL_JPEG - PLL_CLKSEL_R3_OFFSET)) //< Select JPEG clock as PLL13
//@}


/*
    @name H265 clock rate value
...
*/
//@{
#define PLL_CLKSEL_H265_240       (0x00 << (PLL_CLKSEL_H265 - PLL_CLKSEL_R3_OFFSET)) //< Select H.265 clock as 240MHz
#define PLL_CLKSEL_H265_320       (0x01 << (PLL_CLKSEL_H265 - PLL_CLKSEL_R3_OFFSET)) //< Select H.265 clock as 320MHz
#define PLL_CLKSEL_H265_PLL15     (0x02 << (PLL_CLKSEL_H265 - PLL_CLKSEL_R3_OFFSET)) //< Select H.264 clock as PLL15 (for H265)
#define PLL_CLKSEL_H265_PLL13     (0x03 << (PLL_CLKSEL_H265 - PLL_CLKSEL_R3_OFFSET)) //< Select H.264 clock as PLL13 (for IPP)
//@}
#define PLL_CLKSEL_H26X_PLL13	PLL_CLKSEL_H265_PLL13	// backward compatible
#define PLL_CLKSEL_H26X_192     PLL_CLKSEL_H265_240		// backward compatible
#define PLL_CLKSEL_H26X_PLL6    PLL_CLKSEL_H265_240		// backward compatible
#define PLL_CLKSEL_H26X_240		PLL_CLKSEL_H265_240		// backward compatible
...
#define PLL_CLKSEL_GRAPHIC_PLL13    (0x03 << (PLL_CLKSEL_GRAPHIC - PLL_CLKSEL_R3_OFFSET)) //< Select Graphic clock as PLL13 (for IPP)
//@}
...
#define PLL_CLKSEL_AFFINE_PLL13    (0x03 << (PLL_CLKSEL_AFFINE - PLL_CLKSEL_R3_OFFSET)) //< Select Affine clock as PLL13 (for IPP)
//@}
...
#define PLL_CLKSEL_GRAPHIC2_PLL13   (0x03 << (PLL_CLKSEL_GRAPHIC2 - PLL_CLKSEL_R3_OFFSET))  //< Select Graphic2 clock as PLL13 (for IPP)
//@}
...
#define PLL_CLKSEL_SIE3_CLKSRC_PLL13    (0x03 << (PLL_CLKSEL_SIE3_CLKSRC - PLL_CLKSEL_R3_OFFSET))   //< Select SIE3 CLK clock source as PLL13 (for H265)
...
#define PLL_CLKSEL_SIE3_CLKSRC_PLL10    (0x07 << (PLL_CLKSEL_SIE3_CLKSRC - PLL_CLKSEL_R3_OFFSET))   //< Select SIE3 CLK clock source as PLL10 (for CNN)
//@}
...
#define PLL_CLKSEL_SIE_CLKSRC_PLL13     (0x03 << (PLL_CLKSEL_SIE_CLKSRC - PLL_CLKSEL_R3_OFFSET))    //< Select SIE CLK clock source as PLL13 (for H265)
...
#define PLL_CLKSEL_SIE_CLKSRC_PLL10     (0x07 << (PLL_CLKSEL_SIE_CLKSRC - PLL_CLKSEL_R3_OFFSET))    //< Select SIE CLK clock source as PLL10 (for CNN)
//@}
...
#define PLL_CLKSEL_SIE2_CLKSRC_PLL13    (0x03 << (PLL_CLKSEL_SIE2_CLKSRC - PLL_CLKSEL_R3_OFFSET))   //< Select SIE2 CLK clock source as PLL13 (for H265)
...
#define PLL_CLKSEL_SIE2_CLKSRC_PLL10    (0x07 << (PLL_CLKSEL_SIE2_CLKSRC - PLL_CLKSEL_R3_OFFSET))   //< Select SIE2 CLK clock source as PLL10 (for CNN)
//@}
...
*/
//@{
#define PLL_CLKSEL_SDIO_192          (0x00 << (PLL_CLKSEL_SDIO - PLL_CLKSEL_R4_OFFSET))  //< Select SDIO clock as 60Mhz
#define PLL_CLKSEL_SDIO_480          (0x01 << (PLL_CLKSEL_SDIO - PLL_CLKSEL_R4_OFFSET))  //< Select SDIO clock as 80Mhz
...
*/
//@{
#define PLL_CLKSEL_SDIO2_192         (0x00 << (PLL_CLKSEL_SDIO2 - PLL_CLKSEL_R4_OFFSET)) //< Select SDIO2 clock as 60Mhz
#define PLL_CLKSEL_SDIO2_480         (0x01 << (PLL_CLKSEL_SDIO2 - PLL_CLKSEL_R4_OFFSET)) //< Select SDIO2 clock as 80Mhz
...
//@}
#define PLL_CLKSEL_IDE_CLKSRC_PLL2  PLL_CLKSEL_IDE_CLKSRC_480 // compatible
#define PLL_CLKSEL_IDE_CLKSRC_PLL14 PLL_CLKSEL_IDE_CLKSRC_480 // compatible
...
*/
//@{
#define PLL_CLKSEL_SDIO3_192         (0x00 << (PLL_CLKSEL_SDIO3 - PLL_CLKSEL_R5_OFFSET)) //< Select SDIO3 clock as 60Mhz
#define PLL_CLKSEL_SDIO3_480         (0x01 << (PLL_CLKSEL_SDIO3 - PLL_CLKSEL_R5_OFFSET)) //< Select SDIO3 clock as 80Mhz
...
#define PLL_CLKSEL_SIE4_CLKSRC_PLL5     (0x02 << (PLL_CLKSEL_SIE4_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE4 CLK clock source as PLL5 (for sensor1)
#define PLL_CLKSEL_SIE4_CLKSRC_PLL13    (0x03 << (PLL_CLKSEL_SIE4_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE4 CLK clock source as PLL13 (for H265)
#define PLL_CLKSEL_SIE4_CLKSRC_PLL12    (0x04 << (PLL_CLKSEL_SIE4_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE4 CLK clock source as PLL12 (for sensor2)
#define PLL_CLKSEL_SIE4_CLKSRC_320      (0x05 << (PLL_CLKSEL_SIE4_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE4 CLK clock source as 320Mhz
#define PLL_CLKSEL_SIE4_CLKSRC_192      (0x06 << (PLL_CLKSEL_SIE4_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE4 CLK clock source as 192 MHz
#define PLL_CLKSEL_SIE4_CLKSRC_PLL10    (0x07 << (PLL_CLKSEL_SIE4_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE4 CLK clock source as PLL10 (for CNN)
//@}
...
#define PLL_CLKSEL_SIE5_CLKSRC_PLL5     (0x02 << (PLL_CLKSEL_SIE5_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE5 CLK clock source as PLL5 (for sensor1)
#define PLL_CLKSEL_SIE5_CLKSRC_PLL13    (0x03 << (PLL_CLKSEL_SIE5_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE5 CLK clock source as PLL13 (for H265)
#define PLL_CLKSEL_SIE5_CLKSRC_PLL12    (0x04 << (PLL_CLKSEL_SIE5_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE5 CLK clock source as PLL12 (for sensor2)
#define PLL_CLKSEL_SIE5_CLKSRC_320      (0x05 << (PLL_CLKSEL_SIE5_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE5 CLK clock source as 320Mhz
#define PLL_CLKSEL_SIE5_CLKSRC_192      (0x06 << (PLL_CLKSEL_SIE5_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE5 CLK clock source as 192 MHz
#define PLL_CLKSEL_SIE5_CLKSRC_PLL10    (0x07 << (PLL_CLKSEL_SIE5_CLKSRC - PLL_CLKSEL_R7_OFFSET))   //< Select SIE5 CLK clock source as PLL10 (for CNN)
//@}
...
*/
typedef enum {
	DRAMC2_RSTN     = 0,    //< Reset SDRAM2 controller
	...
	CNN2_RSTN,		/*10*/	//< Reset CNN2 controller
	...
	NUE_RSTN,			/*64+ 14*/	//< Reset NUE controller
...
typedef enum {
	...
	CPU2CLK_FREQ,			///< CPU2   CLK Select ID
	DSPCLK_FREQ,			///< DSP    CLK Select ID
