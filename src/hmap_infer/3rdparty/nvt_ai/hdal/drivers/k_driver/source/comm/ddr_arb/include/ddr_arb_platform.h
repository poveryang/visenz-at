...
extern UINT32 IOADDR_DDR_ARB2_REG_BASE;

extern UINT32 IOADDR_DDR_ARB_PROT_REG_BASE;
extern UINT32 IOADDR_DDR_ARB2_PROT_REG_BASE;
...
#if !(defined __UITRON || defined __ECOS)
extern void arb_isr(int is_dprof);
extern void arb2_isr(int is_dprof);
...
extern void dprof_bandwidth_monitor(DDR_ARB id, UINT32 events);
