#ifndef _IPP_SIM_DBG_H_
#define _IPP_SIM_DBG_H_
...
#define CHKPNT                          vk_printk(KERN_INFO  "\033[37mCHK: %d, %s\033[0m\r\n",__LINE__,__func__)
...
extern unsigned int ipp_sim_debug_level;
#define nvt_dbg(level, fmt, args...)                \
	do {                                               \
		if (unlikely(NVT_DBG_##level <= ipp_sim_debug_level))    \
