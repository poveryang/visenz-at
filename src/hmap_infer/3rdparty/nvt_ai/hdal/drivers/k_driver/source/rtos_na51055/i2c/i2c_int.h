...
#define FLGPTN_I2C4 FLGPTN_BIT(3)
#define FLGPTN_I2C5 FLGPTN_BIT(4)
...
#define EMU_I2C_READ_ENG_REG(addr) INW(addr) //ioread32((void __iomem *)(addr | 0xFD000000))
#define EMU_I2C_WRITE_ENG_REG(addr, value) OUTW(addr, value)//iowrite32(value, (void __iomem *)(0xFD000000 + (addr & 0xFFFFF)))
