...
// workaround for 528/530 experiment code, force gyro pinmux
#define NVT_GYRO_528_PINMUX     ENABLE
#define NVT_GYRO_528_PINMUX_SEL 1       // 1: SPI3_1, 2: SPI3_2
#define NVT_GYRO_530_PINMUX     DISABLE
#define NVT_GYRO_530_PINMUX_SEL 1       // 1: SPI3_1, 2: SPI3_2
...
extern unsigned int gyro_spi_debug_level;
#define nvt_dbg(level, fmt, args...)                \
	do {                                               \
		if (unlikely(NVT_DBG_##level <= gyro_spi_debug_level))    \
