...
*/
#define INPUT_LINE_OFFSET_REGISTER0_OFS 0x0024
REGDEF_BEGIN(INPUT_LINE_OFFSET_REGISTER0)
    REGDEF_BIT(DRAM_OFSI0,        17)
REGDEF_END(INPUT_LINE_OFFSET_REGISTER0)


/*
    DRAM_OFSI1:    [0x0, 0x1ffff],			bits : 16_0
*/
#define INPUT_LINE_OFFSET_REGISTER1_OFS 0x0028
REGDEF_BEGIN(INPUT_LINE_OFFSET_REGISTER1)
    REGDEF_BIT(DRAM_OFSI1,        17)
REGDEF_END(INPUT_LINE_OFFSET_REGISTER1)
...
*/
#define LL_TERMINATE_RESISTER0_OFS 0x0090
...
*/
#define DMA_DISABLE_REGISTER0_OFS 0x0094
...
typedef struct
{
    ...
    //0x0024
    T_INPUT_LINE_OFFSET_REGISTER0
    NUE2_Register_0024;

    //0x0028
    T_INPUT_LINE_OFFSET_REGISTER1
    NUE2_Register_0028;
...
*/
#define LL_TERMINATE_RESISTER0_OFS_528 0x0094
REGDEF_BEGIN(LL_TERMINATE_RESISTER0_528)
    REGDEF_BIT(LL_TERMINATE,        1)
REGDEF_END(LL_TERMINATE_RESISTER0_528)
...
*/
#define DMA_DISABLE_REGISTER0_OFS_528 0x0098
REGDEF_BEGIN(DMA_DISABLE_REGISTER0_528)
    REGDEF_BIT(DMA_DISABLE,        1)
    REGDEF_BIT(           ,        14)
    REGDEF_BIT(NUE2_IDLE  ,        1)
REGDEF_END(DMA_DISABLE_REGISTER0_528)
...
typedef struct
{
    ...
    //0x0094
    T_LL_TERMINATE_RESISTER0_528
    NUE2_Register_0094;

    //0x0098
    T_DMA_DISABLE_REGISTER0_528
    NUE2_Register_0098;
