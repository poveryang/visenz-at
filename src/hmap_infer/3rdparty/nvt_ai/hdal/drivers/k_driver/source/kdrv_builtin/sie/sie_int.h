...
//NA//extern void sie_setBSH(UINT32 id, SIE_BS_H_INFO *pBsh);
//NA//extern void sie_getBSH(UINT32 id, SIE_BS_H_INFO *pBsh);
//NA//extern void sie_setBSV(UINT32 id, SIE_BS_V_INFO *pBsv);
//NA//extern void sie_getBSV(UINT32 id, SIE_BS_V_INFO *pBsv);
...
extern VOID sie_setBccIniParm(UINT32 id, SIE_BCC_PARAM_INFO *pBccParam, UINT32 rate);

extern void sie_clr_buffer(UINT32 id);
