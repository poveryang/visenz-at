...
#define H26X_GATING_EN_BIT			29
#define H26X_APB_READ_LOAD_BIT			30
#define H26X_APB_LOAD_BIT			31
...
typedef struct _H26X_HW_REG{
	...
	volatile UINT32 JND_CFG;					// 0x22C
	volatile UINT32 MOTION_BIT_ADDR[3];			// 0x230 ~ 0x238
	volatile UINT32 DBG_CFG;					// 0x23C
	volatile UINT32 DBG_REPORT[3];				// 0x240 ~ 0x248
	volatile UINT32 RES_24C;					// 0x24C
	volatile UINT32 CHK_REPORT[64];			    // 0x250 ~ 0x34C
	volatile UINT32 TILE_CFG[27];            	// 0x350 ~ 0x3B8
	volatile UINT32 RRC_REF_FRM_COEFF4;      	// 0x3BC
	volatile UINT32 SRAQ_CFG_17;				// 0x3C0
	volatile UINT32 RMD_1;					// 0x3C4
	volatile UINT32 JND_CFG_1;				// 0x3C8
	volatile UINT32 BGR_CFG[4];				// 0x3CC ~ 0x3D8
	volatile UINT32 RRC_CFG_11[6];				// 0x3DC ~ 0x3F0
	volatile UINT32 RES_3F4_3FC[3];				// 0x3F4 ~ 0x3FC
	volatile UINT32 OSG_CFG[310];				// 0x400 ~ 0x8D4
	volatile UINT32 NAL_REPORT[2];				// 0x8D8 ~ 0x8DC
	volatile UINT32 RES_8E0_8FC[8];				// 0x8D4 ~ 0x8FC
	volatile UINT32 SDE_CFG[46];				// 0x900 ~ 0x9B4
	volatile UINT32 RES_9B8_9BC[2];				// 0x9B8 ~ 0x9BC
	volatile UINT32 CHK_REPORT_2[64];			// 0x9C0 ~ 0xABC
	volatile UINT32 TNR_CFG[19];				// 0xAC0 ~ 0xB08
	volatile UINT32 RES_B0C[5];				// 0xB0C ~ 0xB1C
	volatile UINT32 LMTBL_CFG[26];				// 0xB20 ~ 0xB84
	volatile UINT32 SLMTBL_CFG[18];				// 0xB88 ~ 0xBCC
}H26X_HW_REG;
