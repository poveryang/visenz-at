...
REGDEF_BIT(, 6)
REGDEF_BIT(FORCE_VBUSI, 1)       // Force VBUSI state
REGDEF_BIT(FORCE_ID, 1)          // Force USB ID level (0: device, 1: host)
...
#if 0
// 0x1A0, Device Endpoint 1~8 Map Register
#define USB_DEVEPMAP1_8_REG_OFS         0x1A0
REGDEF_BEGIN(USB_DEVEPMAP1_8_REG)
REGDEF_BIT(FNO_EP1, 4)           // FIFO number for IN endpoint 1
REGDEF_BIT(FNO_EP2, 4)           // FIFO number for IN endpoint 2
REGDEF_BIT(FNO_EP3, 4)           // FIFO number for IN endpoint 3
REGDEF_BIT(FNO_EP4, 4)           // FIFO number for IN endpoint 4
REGDEF_BIT(FNO_EP5, 4)           // FIFO number for IN endpoint 5
REGDEF_BIT(FNO_EP6, 4)           // FIFO number for IN endpoint 6
REGDEF_BIT(FNO_EP7, 4)           // FIFO number for IN endpoint 7
REGDEF_BIT(FNO_EP8, 4)           // FIFO number for IN endpoint 8
REGDEF_END(USB_DEVEPMAP1_8_REG)

// 0x1A4, Device Endpoint 9~15 Map Register
#define USB_DEVEPMAP9_15_REG_OFS        0x1A4
REGDEF_BEGIN(USB_DEVEPMAP9_15_REG)
REGDEF_BIT(FNO_EP9, 4)           // FIFO number for IN endpoint 9
REGDEF_BIT(FNO_EP10, 4)          // FIFO number for IN endpoint 10
REGDEF_BIT(FNO_EP11, 4)          // FIFO number for IN endpoint 11
REGDEF_BIT(FNO_EP12, 4)          // FIFO number for IN endpoint 12
REGDEF_BIT(FNO_EP13, 4)          // FIFO number for IN endpoint 13
REGDEF_BIT(FNO_EP14, 4)          // FIFO number for IN endpoint 14
REGDEF_BIT(FNO_EP15, 4)          // FIFO number for IN endpoint 15
REGDEF_BIT(, 4)
REGDEF_END(USB_DEVEPMAP9_15_REG)
#endif
...
REGDEF_BIT(FNO_IEP1, 2)          // FIFO number for IN endpoint 1
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_OEP1, 2)          // FIFO number for OUT endpoint 1
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_IEP2, 2)          // FIFO number for IN endpoint 2
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_OEP2, 2)          // FIFO number for OUT endpoint 2
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_IEP3, 2)          // FIFO number for IN endpoint 3
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_OEP3, 2)          // FIFO number for OUT endpoint 3
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_IEP4, 2)          // FIFO number for IN endpoint 4
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_OEP4, 2)          // FIFO number for OUT endpoint 4
REGDEF_BIT(, 2)
...
REGDEF_BIT(FNO_IEP5, 2)          // FIFO number for IN endpoint 5
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_OEP5, 2)          // FIFO number for OUT endpoint 5
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_IEP6, 2)          // FIFO number for IN endpoint 6
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_OEP6, 2)          // FIFO number for OUT endpoint 6
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_IEP7, 2)          // FIFO number for IN endpoint 7
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_OEP7, 2)          // FIFO number for OUT endpoint 7
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_IEP8, 2)          // FIFO number for IN endpoint 8
REGDEF_BIT(, 2)
REGDEF_BIT(FNO_OEP8, 2)          // FIFO number for OUT endpoint 8
REGDEF_BIT(, 2)
...
REGDEF_BIT(ACC_F0, 1)            // Accessing FIFO 0
REGDEF_BIT(ACC_F1, 1)            // Accessing FIFO 1
REGDEF_BIT(ACC_F2, 1)            // Accessing FIFO 2
REGDEF_BIT(ACC_F3, 1)            // Accessing FIFO 3
REGDEF_BIT(ACC_CXF, 1)           // Accessing control transfer FIFO
REGDEF_BIT(, 27)
