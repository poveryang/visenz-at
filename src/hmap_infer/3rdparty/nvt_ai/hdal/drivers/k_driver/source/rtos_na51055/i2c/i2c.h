...
typedef enum {
	...
	I2C_VD_SIE2,            ///< VD source from SIE channel 2, 520 max
...
typedef enum {
	...
	I2C_CONFIG_ID_BUS_CLEAR,		// i2c bus clear
	I2C_CONFIG_ID_AUTO_RST,		    // i2c auto reset
...
*/
#define I2C_FW_MAX_SUPT_ID 5 // max number for [520 : 3 controller, 528: 5 controller]
typedef enum {
...
typedef struct {
	...
	void (*autoRst_En)(I2C_SESSION *Session);
} I2C_OBJ, *PI2C_OBJ;
...
extern void			i2c_autoRst_En(I2C_SESSION *Session);
...
extern void			i2c2_autoRst_En(I2C_SESSION *Session);
...
extern void			i2c3_autoRst_En(I2C_SESSION *Session);
...
//  I2C4 public APIs
//
extern ER           i2c4_open(PI2C_SESSION pSession);
extern ER           i2c4_close(I2C_SESSION Session);
extern BOOL         i2c4_isOpened(I2C_SESSION Session);

extern ER           i2c4_lock(I2C_SESSION Session);
extern ER           i2c4_unlock(I2C_SESSION Session);
extern BOOL         i2c4_islocked(I2C_SESSION Session);

extern void         i2c4_setConfig(I2C_SESSION Session, I2C_CONFIG_ID ConfigID, UINT32 uiConfig);
extern UINT32       i2c4_getConfig(I2C_SESSION Session, I2C_CONFIG_ID ConfigID);

extern I2C_STS      i2c4_transmit(PI2C_DATA pData);
extern I2C_STS      i2c4_receive(PI2C_DATA pData);

extern I2C_RWBIT    i2c4_getRWBit(void);

extern I2C_STS      i2c4_transmitDMA(UINT32 uiAddr, UINT32 uiSize);
extern I2C_STS      i2c4_receiveDMA(UINT32 uiAddr, UINT32 uiSize);

extern I2C_STS      i2c4_waitSARMatch(I2C_SAR_LEN SARLen);

extern I2C_STS      i2c4_transmitDMA_En(UINT32 uiAddr, UINT32 uiSize);
extern I2C_STS      i2c4_transmitDMA_Wait(UINT32 uiAddr, UINT32 uiSize);
extern I2C_STS      i2c4_clearBus_En(void);
extern void			i2c4_autoRst_En(I2C_SESSION *Session);

extern BOOL         i2c4Test_compareRegDefaultValue(void);
extern void         i2c4Test_getClockPeriod(I2C_SESSION Session, double *dHigh, double *dLow);
extern void         i2c4Test_setVDDelay(I2C_SESSION Session, UINT32 uiDelay);

//
//  I2C5 public APIs
//
extern ER           i2c5_open(PI2C_SESSION pSession);
extern ER           i2c5_close(I2C_SESSION Session);
extern BOOL         i2c5_isOpened(I2C_SESSION Session);

extern ER           i2c5_lock(I2C_SESSION Session);
extern ER           i2c5_unlock(I2C_SESSION Session);
extern BOOL         i2c5_islocked(I2C_SESSION Session);

extern void         i2c5_setConfig(I2C_SESSION Session, I2C_CONFIG_ID ConfigID, UINT32 uiConfig);
extern UINT32       i2c5_getConfig(I2C_SESSION Session, I2C_CONFIG_ID ConfigID);

extern I2C_STS      i2c5_transmit(PI2C_DATA pData);
extern I2C_STS      i2c5_receive(PI2C_DATA pData);

extern I2C_RWBIT    i2c5_getRWBit(void);

extern I2C_STS      i2c5_transmitDMA(UINT32 uiAddr, UINT32 uiSize);
extern I2C_STS      i2c5_receiveDMA(UINT32 uiAddr, UINT32 uiSize);

extern I2C_STS      i2c5_waitSARMatch(I2C_SAR_LEN SARLen);

extern I2C_STS      i2c5_transmitDMA_En(UINT32 uiAddr, UINT32 uiSize);
extern I2C_STS      i2c5_transmitDMA_Wait(UINT32 uiAddr, UINT32 uiSize);
extern I2C_STS      i2c5_clearBus_En(void);
extern void			i2c5_autoRst_En(I2C_SESSION *Session);

extern BOOL         i2c5Test_compareRegDefaultValue(void);
extern void         i2c5Test_getClockPeriod(I2C_SESSION Session, double *dHigh, double *dLow);
extern void         i2c5Test_setVDDelay(I2C_SESSION Session, UINT32 uiDelay);
