...
#define FLGUSB_DMA2DONE         FLGPTN_BIT(3)      //  DMA2 done (or abort)
#define FLGUSB_DMA3DONE         FLGPTN_BIT(4)      //  DMA3 done (or abort)
#define FLGUSB_DMA4DONE         FLGPTN_BIT(5)      //  DMA4 done (or abort)
#define FLGUSB_DMA5DONE         FLGPTN_BIT(6)      //  DMA5 done (or abort)
#define FLGUSB_CTLTSK_IDLE      FLGPTN_BIT(7)      //  USB control task idle
#define FLGUSB_SETUPTSK_IDLE    FLGPTN_BIT(8)      //  USB setup task idle
#define FLGUSB_SETUPTSK_STOP    FLGPTN_BIT(9)      //  USB setup task stop
#define FLGUSB_CTLTSK_STOP      FLGPTN_BIT(10)     //  USB control task stop
#define FLGUSB_USER_EVENT_SET   FLGPTN_BIT(11)     //  User Space Event Set
#define FLGUSB_USER_EVENT_DONE  FLGPTN_BIT(12)     //  User Space Event Done

#define FLGUSB_DMADONEALL       (FLGUSB_DMADONE|FLGUSB_DMA2DONE|FLGUSB_DMA3DONE|FLGUSB_DMA4DONE|FLGUSB_DMA5DONE)
...
extern UINT32           gUSBCauseGroup[3];
