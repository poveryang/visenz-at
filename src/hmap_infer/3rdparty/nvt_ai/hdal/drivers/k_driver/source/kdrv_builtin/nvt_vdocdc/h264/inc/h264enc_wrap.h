...
extern void h264Enc_wrapSPFrmCfg(H264ENC_CTX *pVdoCtx, H26XEncAddr *pAddr);
extern void h264Enc_wrapSIFrmCfg(H264ENC_CTX *pVdoCtx, H26XEncAddr *pAddr, UINT32 bs_buf_size);
extern void h264Enc_wrapFirstPFrmCfg(H264ENC_CTX *pVdoCtx, H26XEncAddr *pAddr, UINT32 bs_buf_size);
