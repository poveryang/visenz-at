...
#define NUE2_IOC_RUN2				    _VOS_IOWR(AI_IOC_COMMON_TYPE, 37, void*)
#define NUE2_IOC_GET_PARM_SIZE			_VOS_IOWR(AI_IOC_COMMON_TYPE, 38, void*)
#define AI_IOC_GET_VER			        _VOS_IOWR(AI_IOC_COMMON_TYPE, 39, void*)
