...
typedef enum {
	...
	PIN_SPI_CFG_CH4            = 0x1000,    ///< Enable channel 4. Eanble @P_GPIO17[SPI4_1_CS]|P_GPIO18[SPI4_1_CLK]|P_GPIO19[SPI4_1_DO]. Enable 2BITs && P_GPIO20[SPI4_1_DI])
	PIN_SPI_CFG_CH4_2BITS      = 0x2000,    ///< Enable channel 4. Eanble SPI3_1_DI on P_GPIO[20] or  SPI3_2_DI on MC14 or SPI3_3_DI on P_GPIO[7]
	PIN_SPI_CFG_CH4_2ND_PINMUX = 0x4000,    ///< Enable 2nd pinmux of channel 4. Enable @MC11[SPI4_2_CLK]|MC12[SPI4_2_DO]|MC13[SPI4_2_CS]. Enable 2BITs && MC14[SPI4_2_DI]
	PIN_SPI_CFG_CH4_RDY        = 0x8000,    ///< Not support SPI4

	PIN_SPI_CFG_CH5            = 0x10000,   ///< Enable channel 5. Eanble @P_GPIO17[SPI5_1_CS]|P_GPIO18[SPI5_1_CLK]|P_GPIO19[SPI5_1_DO]. Enable 2BITs && P_GPIO20[SPI5_1_DI])
	PIN_SPI_CFG_CH5_2BITS      = 0x20000,   ///< Enable channel 5. Eanble SPI5_1_DI on P_GPIO[20] or  SPI5_2_DI on MC14 or SPI5_3_DI on P_GPIO[7]
	PIN_SPI_CFG_CH5_2ND_PINMUX = 0x40000,///<    Enable 2nd pinmux of channel 5. Enable @MC11[SPI5_2_CLK]|MC12[SPI5_2_DO]|MC13[SPI5_2_CS]. Enable 2BITs && MC14[SPI5_2_DI]
...
typedef enum {
	...
	PIN_AUDIO_CFG_MCLK = 0x10,             ///< Enable audio I2S_MCLK_1. Enable I2S_MCLK_1@P_GPIO[16])
	PIN_AUDIO_CFG_MCLK_2ND_PINMUX = 0x20,///< Enable audio I2S_MCLK_2. Enable I2S_MCLK_2@D_GPIO[7])
...
typedef enum {
	...
	PINMUX_LCD_SEL_NO_HVSYNC = 0x1 << 27,           ///< No HSYNC/VSYNC  (Not support @528)
