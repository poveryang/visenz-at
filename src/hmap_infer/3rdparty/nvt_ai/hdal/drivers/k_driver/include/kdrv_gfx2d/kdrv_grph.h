...
typedef enum _KDRV_GRPH_PARAM_ID {
	KDRV_GRPH_PARAM_FREQ,	///< [set/get] Frequency config. (unit: MHz)
				///<	valid setting: 240, 320, 360, 480
				///<	(need to be confirmed after realchip back)
...
typedef struct _KDRV_GRPH_TRIGGER_PARAM {
	...
	BOOL		 is_buf_pa;	///< Inform driver that all addresses in p_images are Physical Address (0: normal, 1: PA and skip cache flush)
