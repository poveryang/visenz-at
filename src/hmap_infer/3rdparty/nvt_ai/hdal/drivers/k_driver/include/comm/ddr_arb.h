...
typedef struct _DMA_CH_MSK {
	...
	UINT32 NUE_0: 1;                           //< NUE_0 (in)
	UINT32 NUE_1: 1;                           //< NUE_1 (in)
	UINT32 NUE_2: 1;                           //< NUE_2 (out)
	...
	UINT32 IVE_0: 1;
	UINT32 IVE_1: 1;
	UINT32 SIE4_0: 1; // new channel in 528(137)
	UINT32 SIE4_1: 1;
	UINT32 SIE4_2: 1;
	UINT32 SIE4_3: 1;
	UINT32 SIE5_0: 1;
