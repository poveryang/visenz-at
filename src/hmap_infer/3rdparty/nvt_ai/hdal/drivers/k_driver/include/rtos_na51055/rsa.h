...
extern void rsa_CheckData( UINT32 len);
extern void rsa_CheckData2( UINT32 len);
extern void rsa_CheckData3( UINT32 len);
extern void rsa_getEDOutput(UINT8 * Output, UINT32 len);
#endif
