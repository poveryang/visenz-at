...
typedef enum {
	KDRV_VPE_DCS_DEFAULT = 0, //general case
	KDRV_VPE_DCS_MF,          //mirror/flip
	KDRV_VPE_DCS_WIDE,        //wide angle
	KDRV_VPE_DCS_WALL,        //wall mount fish-eye
	KDRV_VPE_DCS_EIS,         //eis
	KDRV_VPE_DCS_DIS,         //dis
	KDRV_VPE_DCS_ROT,	      //rot
	KDRV_VPE_DCS_CEIL_FLOOR,  //ceil-floor fish-eye	
	KDRV_VPE_DCS_MAX 
} KDRV_VPE_DCS;//dc scenes 


enum KDRV_VPE_DCE_ROT {
...
enum KDRV_VPE_DCE_ROT_RATIO {
	VPE_DRV_DCE_ROT_RAT_FIX_ASPECT_RATIO_UP,
	VPE_DRV_DCE_ROT_RAT_FIX_ASPECT_RATIO_DOWN,//care negative for 528
	VPE_DRV_DCE_ROT_RAT_FIT_ROI,//care negative for 528
	VPE_DRV_DCE_ROT_RAT_MANUAL,//care negative for 528
...
typedef struct _KDRV_VPE_DCE_PARAM_ {
	...
	UINT32  lens_radius;
	KDRV_VPE_DCS  dc_scenes_sel;

 	enum KDRV_VPE_DCE_ROT rot; //only valid at dce_mode = VPE_DRV_DCE_2D_ONLY & dce_2d_lut_en = 0
 	struct KDRV_VPE_DCE_ROT_PARAM rot_param; //only valid at VPE_DRV_DCE_ROT_MANUAL
} KDRV_VPE_DCE_PARAM;
...
typedef enum {
	...
	KDRV_VPE_PARAM_IPL_RESET,				///< vpe hw reset
