...
typedef enum {
	...
	SDIO_CONFIG_ID_CMD23_NON_BLOCKING,      ///< Enable CMD23 read with non blocking
	///< - @b TRUE: Enable the feature
	///< - @b FALSE: Disable the feautre (default value)
...
/**
    SDIO read non-blocking param
*/
typedef struct {
	UINT32  uiSectorAddr;
	UINT32  uiSectorSize;
	UINT8   *pBuf;
} SDIO_READ_NONBLK_CFG, *PSDIO_READ_NONBLK_CFG;
